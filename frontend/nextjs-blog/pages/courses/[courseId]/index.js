...
const CoursePage = () => {
  ...
  const sections = [
    { section: 'Section 1', progress: 50, description: `Welcome to "Introduction to Go Programming," a comprehensive course designed for those new to the Go programming language. Developed at Google, Go is known for its efficiency and ease of use in building web applications and data pipelines.
...
Jumpstart your programming journey with Go and enhance your developer toolkit!`, state: "locked", courseId: "1234", sectionId: "1234"},
   { section: 'Section 1', progress: 50, description: `Welcome to "Introduction to Go Programming," a comprehensive course designed for those new to the Go programming language. Developed at Google, Go is known for its efficiency and ease of use in building web applications and data pipelines.
